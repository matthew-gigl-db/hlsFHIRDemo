```Note that this readme will be updated with run details for the Databricks Health & Life Science FY25 Q4 Interoperability Workshop shortly.  For now please find the demo notebooks in the "src" folder.  The workflow that was triggered from the Redox file arrival may be deployed as a Databricks Asset Bundle, with notebooks found in src/fhir-etl-pipeline.```  
